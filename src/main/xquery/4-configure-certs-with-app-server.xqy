...
declare variable $ORGANIZATION-NAME := "MarkLogic Corporation";
(: declare variable $ORGANIZATION-NAME-2 := "ACME CERTIFICATION CORP"; :)

declare variable $REST-SERVER := "RESTstop";
declare variable $GROUP := "Default";
declare variable $CONFIG := admin:get-configuration();

let $groupid := admin:group-get-id($CONFIG, $GROUP)
let $appservid := admin:appserver-get-id($CONFIG, $groupid, $REST-SERVER)
