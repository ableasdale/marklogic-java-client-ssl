...
public class Configuration {
    ...
    protected static String createRestServerXmlPayload() {
        PropertiesConfiguration props = getPropertiesConfiguration();
        return new StringBuilder().append("<rest-api xmlns=\"http://marklogic.com/rest-api\">").append("<name>RESTstop</name>").append("<database>Documents</database>").append("<port>").append(props.getString("PORT")).append("</port>").append("</rest-api>").toString();
    }
}